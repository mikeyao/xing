    ...
    <div class="section">
          ...
          <article>
            ...
            <div class="columns">
              <div class="column">
                <ul>
                  <li>Individual ideate on wireframes based on learning from user interviews and competitor news platforms</li>
                  <li>2 rounds of presenting ideas to team and get feedback</li>
                </ul>
              </div>
              <div class="column">
                <ul>
                  <li>Converge Ideas</li>
